				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<div>
							...
							<label>所属区域</label> 
							<select id="area" style="padding-top: 5px;padding-bottom: 5px;margin-top: 10px;margin-bottom: 10px">
								<option></option>
							</select>
							<label>监控内容</label> 
							<select id="content" style="padding-top: 5px;padding-bottom: 5px;margin-top: 10px;margin-bottom: 10px">
								<option>全部</option>
							...
							<button class="btn btn-white" onclick="">可疑工单验证</button>
							<label for="checkbox6"><input id="doubtwork" type="checkbox" name="doubtwork">可疑工单</label>
							<input id="import" type="file" accept="application/vnd.ms-excel" value="导入" name="导入" >
